-- Données de base complètes pour le projet Pharmacie
...
-- ==========================================================
-- 2. INSERTION DES FOURNISSEURS (Vérifiés pour votre Sandbox)
-- ==========================================================
INSERT INTO FOURNISSEUR (NOM, EMAIL) VALUES
('Global Pharma', 'lucasrodriguez260805+global@gmail.com'),
('Euro Meds', 'lucasrodriguez260805+euro@gmail.com'),
('Sénégal Santé Distribution', 'lucasrodriguez260805+distrib@gmail.com');

-- ==========================================================
-- 3. LIAISON FOURNISSEUR_CATEGORIE (2 par catégorie)
-- ==========================================================
INSERT INTO fournisseur_categorie (fournisseur_id, categorie_code) VALUES 
(1, 1), (2, 1), (2, 2), (3, 2), (1, 3), (3, 3), (1, 4), (2, 4), (2, 5), (3, 5),
(1, 6), (3, 6), (1, 7), (2, 7), (2, 8), (3, 8), (1, 9), (3, 9), (2, 10), (3, 10);

-- ==========================================================
-- 4. INSERTION DES MEDICAMENTS (10 par catégorie)
-- ==========================================================
...
('Ibuprofène 200mg', 1, 'Boîte de 20 comprimés', 3.80, 40, 0, 45, false, 'https://images.unsplash.com/photo-1550572017-edd951aa8f72?w=400'), -- Alerte !
...
INSERT INTO MEDICAMENT (NOM, CATEGORIE_CODE, QUANTITE_PAR_UNITE, PRIX_UNITAIRE, UNITES_EN_STOCK, UNITES_COMMANDEES, NIVEAU_DE_REAPPRO, INDISPONIBLE, imageURL) VALUES
('Diclofénac 50mg', 2, 'Boîte de 20 comprimés', 5.60, 30, 0, 35, false, 'https://images.unsplash.com/photo-1628771065518-0d82f1938462?w=400'), -- Alerte !
...
('Amoxicilline + Acide Clavulanique 1g', 3, 'Boîte de 8 comprimés', 8.50, 35, 0, 40, false, 'https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=400'), -- Alerte !
...
-- ==========================================================
-- 7. INSERTION DES LIGNES DE COMMANDE
-- ==========================================================
